...
@section('scripts')
    ...
    <script>
        ...
        function loadData() {
            ...
            $.ajax({
                url: '{{ route("invoices.data") }}?' + params.toString(),
                method: 'GET',
                beforeSend: function() {
                    $('#loadingOverlay').show();
                },
        ...
        $(document).ready(function() {
            // Tabulator tablosu oluştur
            table = new Tabulator("#invoiceTable", {
                data: [],
                layout: "fitColumns",
                height: "600px",
                virtualDom: true, // Performans için virtual DOM
                pagination: true,
                paginationSize: 50,
                ...
                columns: [
                    ...
                    {title: "Şirket", field: "CompanyCode", sorter: "string"}
                ],
            });
